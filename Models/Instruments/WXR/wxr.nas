...
var objName_capt = 'wxr.l';		# Model object name for captain's side WXR
var objName_fo = 'wxr.r';		# Model object name for first officer's side WXR
...
var mySwitches = {
	...
	'toggle_wxr':			{	path: '/inputs/wx'			, value: 0	}
};

# Define data properties used by aircraft (instrumentation/gps usually)
var dataProps = {
	:	'/flight-management/flightplan/currentWpt'
};
